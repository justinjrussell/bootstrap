...
4. Run `grunt test-js` to see the results of your newly-added test(s). They should fail before your changes are applied to the plugin, and should pass after your changes are applied to the plugin.
